...
if 1 
    ...
    figure;
    subplot(3,1,1); stem(sys_est.theta_ML,'linewidth',2); title('ML');
    ylim([m M]);
    subplot(3,1,2); stem(sys_est.theta_sp,'linewidth',2); title('ell_1');
    ylim([m M]);
    subplot(3,1,3); stem(sys_est.theta_OMP,'linewidth',2); title('OMP');
    ylim([m M]);
